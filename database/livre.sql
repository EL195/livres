...
--
-- Hôte : localhost:3306
-- Généré le : mer. 09 juin 2021 à 09:10
...
INSERT INTO `citations` (`id`, `name`, `author`, `Description`) VALUES
(1, 'Livre test', 'Hurbain', ' descriptTestion ou bien rÃ©sume...'),
(4, 'tes', 'test', 'test');
...
INSERT INTO `emp` (`id`, `auth`, `livre`) VALUES
(1, 'test', 'test'),
(3, 'tr', 'gg');
